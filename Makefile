all:
	javac -d bin/ -cp lib/htmlparser.jar:lib/rome-1.0RC2.jar:lib/rome-fetcher-1.0RC2.jar:lib/jdom.jar:lib/junit-4.5.jar:$(CLASSPATH) src/edu/iit/swyne/crawler/*.java \
...
crawl:
	java -cp bin:lib/htmlparser.jar:lib/rome-1.0RC2.jar:lib/rome-fetcher-1.0RC2.jar:lib/jdom.jar:lib/junit-4.5.jar:$(CLASSPATH) edu.iit.swyne.crawler.server.SwyneCrawlerServer&
